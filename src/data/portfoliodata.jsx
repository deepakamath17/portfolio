...
I focus on full-stack web development, creating secure and interactive web applications using PHP, MySQL, HTML, CSS, JavaScript, and React. My project experience spans building centralized academic monitoring systems and AI-based adaptive learning platforms.`,
  ...
  education: [
    ...
    },
    {
      ...
      duration: "Completed",
      description:
        "Gained a strong foundation in computer applications, database management systems, web development, and programming logic.",
    },
  ],
skills: [
  ...
  { name: "Python", category: "Backend", level: "Intermediate" }, // <-- Added here
