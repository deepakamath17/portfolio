import { ArrowRight, Download, GitBranch, Link as LinkIcon } from "lucide-react";
      ...
      <div className="mx-auto max-w-6xl w-full">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div className="flex-1 space-y-6 text-left">
            ...
            {/* Heading */}
            <div>
              <p className="text-xs uppercase tracking-[0.3em] font-semibold text-white mb-2">
                Hello, I'm
              </p>
              <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight gradient-text whitespace-nowrap">
                {portfolioData.name}
              </h1>
